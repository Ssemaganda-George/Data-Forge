    ...
    <div>
      ...
      <div className="bg-white border border-[#E5E7EB] rounded-xl p-6">
        ...
        <div className="flex flex-wrap gap-3">
          <Link href="/admin/users" className="text-sm font-medium text-white bg-[#028090] rounded-md px-4 py-2 hover:bg-[#026c78] transition-colors">
            Manage Users
          </Link>
          <Link href="/admin/inquiries" className="text-sm font-medium text-white bg-[#028090] rounded-md px-4 py-2 hover:bg-[#026c78] transition-colors">
            View Inquiries
          </Link>
          <Link href="/admin/subscriptions" className="text-sm font-medium text-white bg-[#028090] rounded-md px-4 py-2 hover:bg-[#026c78] transition-colors">
